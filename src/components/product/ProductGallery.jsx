            ...
            >
                  ...
                  <div onClick={(e) => e.stopPropagation()}>
                    {mounted && isDesktop && (
                      <TryOnButton 
                        ...
                        className="group absolute bottom-4 left-4 flex items-center py-2 px-3 rounded-full border border-gray-100 bg-white/95 backdrop-blur-sm shadow-sm overflow-hidden transition-all duration-500 ease-in-out z-30"
                      />
                    )}
                  </div>
                </>
              ...
              {index === 1 && hasSimilar && (
                <button 
                  ...
                  className={`group absolute bottom-4 right-4 flex items-center rounded-full border border-gray-100 bg-white/95 backdrop-blur-sm shadow-sm overflow-hidden transition-all duration-500 ease-in-out z-30
                  ...
                  <span
                    className={`whitespace-nowrap overflow-hidden transition-all duration-500 ease-in-out text-[12px] font-bold uppercase tracking-wider
                      ${showText ? "max-w-55 opacity-100 ml-2" : "max-w-0 opacity-0 ml-0"}
                    `}
                    >
                    Similar Items
                  </span>
             ...
             <div onClick={(e) => e.stopPropagation()} className="data-no-swiping">
               {mounted && !isDesktop && (
                 <TryOnButton 
                   ...
                   className="bg-white/95 backdrop-blur-sm py-2 px-3 rounded-full text-[12px] font-bold flex items-center shadow-sm border border-gray-100 uppercase tracking-wider cursor-pointer"
                 />
               )}
             </div>
             <button 
              ...
              onMouseLeave={() => {
               ...
               className={`flex items-center rounded-full border border-gray-100 bg-white/95 backdrop-blur-sm shadow-sm overflow-hidden transition-all duration-500 ease-in-out z-30
                    ${showText ? "py-2 px-3 pr-5" : "px-3 py-2"}
                  `}
             >
               <span className="w-6 h-6 shrink-0 flex items-center justify-center">
