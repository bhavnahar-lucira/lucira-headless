...
const CATEGORIES = [
  ...
  { id: 1, name: "Earrings", handle: "all-earrings", image: "/images/range/Earrings.jpg" },
  { id: 2, name: "Bracelets", handle: "all-bracelets", image: "/images/range/Bracelets.jpg" },
  { id: 3, name: "Necklaces", handle: "all-necklaces", image: "/images/range/Necklaces.jpg" },
  { id: 5, name: "Nosepins", handle: "all-nosepins", image: "/images/range/Nosepin.jpg" },
  { id: 4, name: "Mangalsutra", handle: "all-mangalsutra", image: "/images/range/Mangalsutra.jpg" },
  { id: 4, name: "Men's Ring", handle: "all-mens-ring", image: "/images/range/MensRing.jpg" },
  { id: 4, name: "Men's Stud", handle: "all-mens-stud", image: "/images/range/MensStud.jpg" },
];
