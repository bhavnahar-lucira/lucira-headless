...
export default function BackToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={cn(
        "fixed top-1/2 right-0 -translate-y-1/2 z-[100] p-3 rounded-full bg-black text-white shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 group",
