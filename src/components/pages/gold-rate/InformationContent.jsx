...
export default function InformationContent({ cityName, stateName, sectionData }) {
  ...
  return (
    <section className="information-content-section py-15 md:py-2 bg-white">
      <div className="container-main px-4">
              ...
              {storeBlocks.map((block, idx) => (
                <div key={idx} className="store-location-item space-y-6">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-center gap-4 text-[14px] md:text-[16px] text-zinc-500 font-figtree">
                    ...
                    <li className="flex items-start gap-4 text-[14px] md:text-[16px] text-zinc-500 font-figtree">
        ...
        <div className="information-content-wrapper prose prose-zinc max-w-4xl mx-auto prose-headings:font-abhaya prose-headings:uppercase prose-headings:tracking-wider prose-headings:text-zinc-900 prose-p:text-zinc-600 prose-p:leading-relaxed prose-p:font-figtree prose-li:text-zinc-600 prose-li:font-figtree prose-strong:text-zinc-900 prose-a:text-primary prose-a:underline">
          {contentBlocks.map((block, idx) => {
            if (block.type === 'heading') {
              ...
              return (
                <Tag
                  ...
                  className={`text-${block.settings.alignment || 'left'} text-[18px] md:text-[28px] mt-16 mb-8`}
                >
            ...
            if (block.type === 'richtext') {
              return (
                <div
                  key={idx}
                  className="information-content-richtext mb-10 text-[14px] md:text-[18px]"
