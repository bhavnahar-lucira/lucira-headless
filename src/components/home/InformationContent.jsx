    ...
    <section className="information-content-section bg-white pt-12 pb-4 lg:pt-16 lg:pb-16 border-t border-zinc-100">
      <div className="container-main">
        ...
        {storeLocations.length > 0 && (
          <div className="address-locations-footer mb-12 lg:mb-16">
            <h3 className="text-[18px] lg:text-[24px] font-bold font-abhaya text-zinc-900 mb-6 lg:mb-8 pb-4 border-b border-zinc-100 tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-12 lg:gap-y-10 lg:gap-x-0">
              {storeLocations.map((block, index) => (
                ...
                >
                  <h4 className="text-[14px] lg:text-[16px] font-bold font-figtree text-zinc-800 mb-4 lg:mb-5 leading-tight tracking-tight uppercase">
        ...
        <div className="information-content-wrapper footer-pages border-t border-zinc-100 pt-0 lg:pt-12 !text-[12px] lg:!text-[14px]">
          {contentBlocks.map((block, index) => (
            <div key={index} className="mb-4 lg:mb-2 last:mb-0">
              {block.type === 'heading' ? (
                <h2 className="text-[16px] lg:text-[20px] font-bold text-zinc-900 mt-6 lg:mt-9 mb-4 pb-2 border-b border-zinc-200 font-abhaya tracking-tight">
                  {block.settings.text}
                </h2>
              ) : (
                <div
                  className="richtext-content [&_p]:!text-[12px] lg:[&_p]:!text-[14px] [&_h3]:!text-[14px] lg:[&_h3]:!text-[16px] [&_p]:mb-4 last:[&_p]:mb-0"
