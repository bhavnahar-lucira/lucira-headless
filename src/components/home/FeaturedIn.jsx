...
export default function FeaturedIn() {
  ...
  return (
    <section className="w-full text-center bg-white overflow-hidden">
        ...
        >
          <div className="flex items-center gap-16 px-8">
            {logos.map((logo, index) => (
              <Link href={logo.url} key={index} target="_blank" rel="noopener noreferrer" className="block">
                <LazyImage
                  src={logo.image}
                  ...
                  className="h-18 md:h-20 w-auto object-contain opacity-60 hover:opacity-100 transition-opacity duration-300"
                />
              </Link>
            ))}
          </div>
