        ...
        <Swiper
          ...
          pagination={{
            ...
            renderBullet: (index, className) => {
              return `<span class="${className} w-2! h-2! rounded-full! bg-gray-700! transition-all duration-300 [&.swiper-pagination-bullet-active]:bg-primary! [&.swiper-pagination-bullet-active]:w-[24px]!"></span>`;
            },
          }}
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="mt-auto space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <Button asChild variant="outline" className="h-11 rounded-sm border-zinc-200 text-zinc-600 hover:border-[#25D366] hover:text-[#25D366] font-figtree font-semibold text-[14px] tracking-[0.4px] transition-all">
                        ...
                        {/* Get Directions */}
                        <Button asChild className="h-11 rounded-sm bg-[#5B4740] hover:bg-[#4A3934] text-white font-figtree font-semibold text-[14px] tracking-[0.4px] transition-all">
