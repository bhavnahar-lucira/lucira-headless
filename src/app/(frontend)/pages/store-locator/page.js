...
const allStores = [
  ...
  },
  {
    ...
    appointmentLink: "/book-appointment?store=malad",
    lat: 19.1743,
    lng: 72.8445,
...
function checkIfOpen(timingsStr) {
  try {
    ...
    const timePart = timingsStr.split("|")[1].trim(); // "10:00 am - 9:00 pm"
    ...
    const now = new Date();
    // Day check: 0 is Sunday, 1-6 is Monday-Saturday
...
export default function StoreLocatorPage() {
  ...
  const handleSearch = () => {
    ...
    // Check if query is a pincode (basic 6-digit India pincode check)
    if (/^\d{6}$/.test(query)) {
  ...
  const handleLocateMe = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (pos) => {
        ...
        // Optionally reverse geocode to show city/pincode
  ...
  return (
    <div className="font-figtree text-[#333]">
      {/* ═══════════════════════════════════════════
          1. HERO SECTION (BANNER SLIDER) - HOMEPAGE STYLE
      ═══════════════════════════════════════════ */}
          ...
          <div className="max-w-[750px] mx-auto mb-12 md:mb-15">
            ...
            <div className="flex flex-col items-center">
              <Button 
                ...
                className="h-14 px-8 border-zinc-200 text-zinc-800 hover:bg-zinc-50 rounded-sm font-bold tracking-widest text-xs uppercase transition-all"
              >
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="mt-auto space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <Button asChild variant="outline" className="h-11 rounded-sm border-zinc-200 text-zinc-600 hover:border-primary hover:text-primary text-[10px] font-black uppercase tracking-widest transition-all">
                          <a href={store.callLink}>Call Us</a>
                        </Button>
                        <Button asChild className="h-11 rounded-sm bg-[#5B4740] hover:bg-[#4A3934] text-white text-[10px] font-black uppercase tracking-widest transition-all">
                          <a href={store.appointmentLink}>Book Visit</a>
                        </Button>
                      </div>
                    </div>
                  </div>
