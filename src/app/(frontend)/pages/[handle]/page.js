...
const allStores = [
  ...
  },
  {
    ...
    whatsappLink: "https://api.whatsapp.com/send/?phone=%2B919004402038&text=Hi%2C+I%E2%80%99d+like+to+visit+the+Chembur+Lucira+store+and+explore+the+designs.&type=phone_number&app_absent=0",
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="mt-auto space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <Button asChild variant="outline" className="h-11 rounded-sm border-zinc-200 text-zinc-600 hover:border-[#25D366] hover:text-[#25D366] text-[10px] font-black uppercase tracking-widest transition-all">
                        ...
                        <Button asChild className="h-11 rounded-sm bg-[#5B4740] hover:bg-[#4A3934] text-white text-[10px] font-black uppercase tracking-widest transition-all">
                          <a href={store.directionsLink} target="_blank" rel="noopener noreferrer">Get Directions</a>
                        </Button>
                      </div>
                    </div>
                  </div>
