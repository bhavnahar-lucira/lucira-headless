...
export default function AboutPage() {
    const data = {
        aboutBlack: "https://www.lucirajewelry.com/cdn/shop/files/about_us_2.png?v=1760097369&width=1200",
        aboutWhite: "https://www.lucirajewelry.com/cdn/shop/files/about_us_3.png?v=1760097396&width=1200",
        founderImage: "https://www.lucirajewelry.com/cdn/shop/files/Group_1321315953_2.png?crop=center&height=700&width=560",
        ...
        <>
            <section className="relative w-full overflow-hidden text-center py-10 md:py-16 px-4 md:px-5">
                <div className="max-w-[1200px] mx-auto relative">
                    <div className="absolute top-[50px] md:top-[70px] left-1/2 -translate-x-1/2 w-full flex justify-center z-0 pointer-events-none">
                        <div className="relative w-[90%] md:w-[1000px] h-[100px] md:h-[160px]">
                            <Image src={data.aboutBlack} alt="About Us" fill className="object-contain" priority />
                        </div>
                    </div>
                    <div className="pt-[100px] md:pt-[140px] flex flex-col items-center">
                        <div className="relative w-full max-w-[420px] flex flex-col items-center mb-10">
                            <div className="absolute inset-0 overflow-hidden z-20 pointer-events-none">
                                <div className="absolute left-1/2 -translate-x-1/2 top-[-60px] md:top-[-88px] w-[90%] md:w-[1000px] h-[120px] md:h-[200px]">
                                    <Image src={data.aboutWhite} alt="About Us White" fill className="object-contain" />
                                </div>
                                <div className="absolute bottom-[-40px] md:bottom-[-60px] right-[-40px] md:right-[-80px] w-[100px] md:w-[150px] h-[100px] md:h-[150px]">
                                    <Image src={data.signatureWhite} alt="Signature White" fill className="object-contain" />
                                </div>
                            </div>
                            
                            <div className="relative z-10 w-full h-[420px] md:h-[700px]">
                                <Image src={data.founderImage} alt={data.founderName} fill className="object-cover rounded" />
                            </div>
                            <div className="absolute bottom-[-40px] md:bottom-[-60px] right-[-40px] md:right-[-80px] w-[100px] md:w-[150px] h-[100px] md:h-[150px] z-0">
                                <Image src={data.signatureBlack} alt="Signature Black" fill className="object-contain" />
                            </div>
                            
                            <div className="absolute bottom-0 left-0 md:left-[-170px] text-left">
                        ...
                        <blockquote className="max-w-[90%] md:max-w-[800px] text-gray-600 italic text-[16px] md:text-[20px] leading-[28px] md:leading-[32px] pt-6 md:pt-10">
                            {data.founderQuote}
                        </blockquote>
                    </div>
                </div>
            ...
            <section className="w-full bg-white py-12 md:py-16 overflow-x-auto">
                <div className="max-w-[1300px] mx-auto relative">
                    ...
                    <div className="absolute top-[35%] left-0 w-full h-[2px] bg-[#b8957a] -translate-y-1/2 z-0 hidden md:block" />

                    <div className="flex md:justify-between items-center gap-8 px-5 relative z-10 min-w-max md:min-w-0">
                        {timelineData.map((item, index) => (
                            <div key={index} className="flex flex-col items-center min-w-[260px]">
                                <div className="text-[16px] md:text-[20px] mb-6">{item.year}</div>
                                <div className="w-[60px] md:w-[80px] h-[60px] md:h-[80px] mb-6 relative">
                                    <Image src={item.image} alt={item.title} fill className="object-cover rounded-full border-[3px] border-white shadow-md" />
                                </div>
                                <div className="text-center max-w-[260px]">
                                    <h3 className="text-[16px] md:text-[18px] font-medium uppercase mb-3">
                                        {item.title}
                                    </h3>
            ...
            <section className="w-full py-10 md:py-16 bg-white">
                <div className="max-w-[1400px] mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12">        
                    <div className="relative flex flex-col gap-6 md:gap-8">            
                        ...
                        ">
                            ...
                            <p className="text-[14px] md:text-[16px] leading-[22px] md:leading-[24px] tracking-wide text-gray-600">
                    ...
                    <div className="relative flex flex-col-reverse gap-6 md:gap-8 mt-8 md:mt-16">            
                        <div className="relative w-full h-[300px] sm:h-[400px] md:h-[600px] md:mt-[400px]">
                            <Image 
            ...
            <section className="w-full py-10 md:pt-16 md:pb-8">
                <div className="max-w-[1200px] mx-auto px-6">
                    <div className="relative w-full rounded-[10px] overflow-hidden">
                        <div className="relative w-full h-[180px] xl:h-[600px] lg:h-[500px] md:h-[400px]">
                            <Image
                        ...
                        <div className="w-full bg-[#f2f2f2] text-center px-4 py-6 mt-4 xl:absolute xl:inset-0 xl:bg-transparent xl:flex xl:flex-col xl:justify-end xl:items-center xl:text-white xl:px-5 xl:pb-8 xl:mt-0">
                            <p className="text-[16px] sm:text-[20px] md:text-[24px] font-normal opacity-80">
                                OUR TEAM, OUR FAMILY
                            </p>
                            <p className="text-[14px] sm:text-[16px] md:text-[18px] max-w-[90%] md:max-w-[800px] mt-2 leading-[1.4]">
