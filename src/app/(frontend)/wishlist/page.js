...
import { removeWishlistItem, removeGuestWishlistItem, fetchWishlist } from "@/redux/features/wishlist/wishlistSlice";
...
export default function PublicWishlistPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FDFDFD] pt-10 pb-20">
      <div className="container-main mx-auto px-4 md:px-6">
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="font-figtree text-3xl md:text-4xl font-bold text-zinc-900 tracking-tight mb-2">My Wishlist</h1>
              <p className="text-zinc-500 font-medium">Your curated selection of exquisite Lucira pieces.</p>
            </div>
            {isAuthenticated && (
              <button
