              ...
              {[1,2,3,4].map(n => {
                ...
                return (
                  <li key={n} className={`flex items-center gap-[9px] text-[11.5px] ${done ? "text-[#1c1410]" : "text-[#9a8f85]"}`}>
                    <div className={`w-[24px] h-[18px] rounded-full border-[1.5px] flex items-center justify-center shrink-0 ${done ? "bg-[#5A413F] border-transparent" : "bg-white border-[#e5ddd4]"}`}>
