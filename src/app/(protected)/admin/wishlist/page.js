  ...
  if (loading) {
    return (
      <div className="font-figtree flex flex-col items-center justify-center min-h-[60vh] space-y-4 bg-white rounded-[2rem] md:rounded-[3rem] border border-zinc-100">
        ...
        <p className="text-zinc-400 font-semibold uppercase tracking-[0.13em] text-xs">
  ...
  return (
    <div className="font-figtree space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl md:text-3xl font-bold text-zinc-900 tracking-tight mb-1">
            My Profile
          </h2>
          <p className="text-sm md:text-base text-zinc-500 font-normal leading-relaxed">
        ...
        <button
          ...
          disabled={isSaving}
          className="px-6 md:px-8 py-3 bg-primary text-white text-xs font-semibold uppercase tracking-[0.15em] rounded-2xl hover:opacity-90 transition-colors shadow-lg shadow-primary/20 flex items-center gap-2 w-fit disabled:opacity-50"
        >
          {isSaving ? (
          ...
          <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] border border-zinc-100 p-6 md:p-8 lg:p-10 space-y-6 md:space-y-8 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-semibold text-zinc-400 uppercase tracking-[0.13em] ml-1">
                  First Name
                </label>
                <Input
                  value={formData.firstName}
                  onChange={(e) => handleInputChange("firstName", e.target.value)}
                  className="h-12 md:h-14 rounded-2xl border-zinc-100 bg-zinc-50/50 focus:bg-white transition-all font-medium text-zinc-900 text-sm"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    disabled
                    className="h-12 md:h-14 rounded-2xl border-zinc-100 bg-zinc-50/50 font-medium text-zinc-400 pl-11 md:pl-12 cursor-not-allowed text-sm"
                  />
                  <Mail
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-12 md:h-14 rounded-2xl border-zinc-100 bg-zinc-50/50 focus:bg-white transition-all font-medium text-zinc-900 pl-11 md:pl-12 text-sm"
                  />
                  <Phone
                    className="absolute left-3.5 md:left-4 top-1/2 -translate-y-1/2 text-zinc-300"
                    size={17}
        ...
        <div className="space-y-6 md:space-y-8">
          <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] border border-zinc-100 p-6 md:p-8 text-center space-y-5 md:space-y-6 shadow-sm">
            ...
            <div className="relative size-28 md:size-32 mx-auto">
              ...
              >
                {profileImage ? (
                  ...
                  <span className="text-[3rem] md:text-[3.5rem] font-bold text-white/95 uppercase drop-shadow-sm">
            ...
            <div className="pt-5 md:pt-6 border-t border-zinc-100 grid grid-cols-2 gap-4">
              <div>
                <p className="text-[10px] font-semibold text-zinc-300 uppercase tracking-[0.13em] mb-1">
                  Orders
                </p>
