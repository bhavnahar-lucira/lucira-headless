  ...
  if (!order) {
    return (
      <div className="text-center py-20">
        ...
        <h3 className="text-xl font-black text-zinc-900">Order not found</h3>
        <Link href="/admin/orders" className="text-primary hover:underline mt-4 block">
          Back to all orders
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-black text-zinc-900 tracking-tight">Order #{order.orderNumber}</h2>
          <p className="text-zinc-500 font-medium">Placed on {new Date(order.processedAt).toLocaleDateString('en-IN', {
            year: 'numeric',
            month: 'long',
            day: 'numeric'
          })}</p>
      ...
      <div className="bg-white rounded-[2.5rem] border border-zinc-100 p-8 shadow-sm">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
          ...
          <div className="flex items-center gap-2 text-zinc-400">
            <Truck size={18} />
            <span className="text-xs font-black uppercase tracking-widest">Live tracking available</span>
          </div>
        </div>
              ...
              return (
                <div key={stage} className="flex flex-row md:flex-col items-center gap-4 md:text-center">
                  ...
                  <div className="space-y-1">
                    <p className={`text-[10px] font-black uppercase tracking-widest ${isCompleted ? "text-zinc-900" : "text-zinc-400"}`}>
                      {stage}
                    </p>
                    {index === 0 && (
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-[2.5rem] border border-zinc-100 overflow-hidden shadow-sm">
            <div className="p-8 border-b border-zinc-100">
              <h3 className="text-xl font-black text-zinc-900">Items in this order</h3>
            </div>
              ...
              {order.lineItems.map((item, index) => (
                <div key={index} className="p-8 flex gap-6 items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg font-black text-zinc-900 mt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-[2.5rem] border border-zinc-100 p-8 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-black text-zinc-900">Payment</h3>
              </div>
            ...
            <div className="bg-white rounded-[2.5rem] border border-zinc-100 p-8 shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-lg font-black text-zinc-900">Delivery Address</h3>
              </div>
